...
instructions! {
  ...
  [JO , exec_jo , [B(0x70, 8), IP8, I(D,0)]],
  [JNO, exec_jno, [B(0x71, 8), IP8, I(D,0)]],
  [JB , exec_jb , [B(0x72, 8), IP8, I(D,0)]],
  [JNB, exec_jnb, [B(0x73, 8), IP8, I(D,0)]],
  [JZ , exec_jz , [B(0x74, 8), IP8, I(D,0)]],
  [JNZ, exec_jnz, [B(0x75, 8), IP8, I(D,0)]],
  [JNA, exec_jna, [B(0x76, 8), IP8, I(D,0)]],
  [JA , exec_ja , [B(0x77, 8), IP8, I(D,0)]],
  [JS , exec_js , [B(0x78, 8), IP8, I(D,0)]],
  [JNS, exec_jns, [B(0x79, 8), IP8, I(D,0)]],
  [JP , exec_jp , [B(0x7a, 8), IP8, I(D,0)]],
  [JNP, exec_jnp, [B(0x7b, 8), IP8, I(D,0)]],
  [JL , exec_jl , [B(0x7c, 8), IP8, I(D,0)]],
  [JNL, exec_jnl, [B(0x7d, 8), IP8, I(D,0)]],
  [JNG, exec_jng, [B(0x7e, 8), IP8, I(D,0)]],
  [JG , exec_jg , [B(0x7f, 8), IP8, I(D,0)]],

  [LOOPNZ, exec_loopnz, [B(0xe0, 8), IP8, I(D,0)]],
  [LOOPZ , exec_todo, [B(0xe1, 8), IP8, I(D,0)]],
  [LOOP  , exec_loop, [B(0xe2, 8), IP8, I(D,0)]],
